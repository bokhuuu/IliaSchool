...
export default function AgeGroupEdit({ ageGroup: { data: ageGroup } }: Props) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        sort_order: ageGroup.sort_order || 0,
                ...
                <form onSubmit={submit} className="max-w-2xl space-y-6">
                    ...
                    <div className="space-y-4 rounded-lg border p-6">
                        ...
                        <p className="text-xs text-muted-foreground">
                            რეკომენდირებული ზომა: 1200×1200px (aspect ratio 1:1)
                        </p>
                        {ageGroup.image && !preview && (
                            <img
                                src={ageGroup.image_thumb || ageGroup.image}
                                alt=""
